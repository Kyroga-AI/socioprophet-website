...
const ROUTES = [
  {
    ...
    description: "Stop renting AI. Start building a brain you own. Free, self-managed Noetica runs on your own computer: no AI bills, and your IP stays on your machine.",
